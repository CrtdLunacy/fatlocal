...
import styles from './MenuDeleteDialog.module.scss';
...
export const MenuDeleteDialog = (props: MenuDeleteDialogProps) => {
    const {
        className,
        onClose,
        onDelete,
    ...
    return (
        <div className={classNames(styles.MenuDeleteDialog, {}, [className])}>
